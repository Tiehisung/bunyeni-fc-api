// controllers/stats/matchStats.controller.ts
...
export const getMatchStats = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            error: getErrorMessage(err, "Failed to calculate match stats"),
        });
    }
};

// GET /api/stats/matches/detailed
export const getDetailedMatchStats = async (req: Request, res: Response) => {
    try {
        ...
        const matchStats = await MatchModel.aggregate([
            {
                $match: {
                    ...seasonFilter,
        ...
        res.status(500).json({
            success: false,
            error: getErrorMessage(err, "Failed to calculate detailed match stats"),
        });
    }
};

// GET /api/stats/matches/home-away
export const getHomeAwayStats = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            error: getErrorMessage(err, "Failed to calculate home/away stats"),
        });
    }
};

// GET /api/stats/matches/form
export const getFormGuide = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            error: getErrorMessage(err, "Failed to calculate form guide"),
        });
    }
};
...
export const getStreaks = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            error: getErrorMessage(err, "Failed to calculate streaks"),
        });
    }
};
